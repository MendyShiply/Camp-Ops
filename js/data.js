(function () {
  ...
  window.CampOpsSeed = {
    ...
    locations: [
      ["10c", "10C Medical Center", "Medical"], ["10d", "10D Kiddie Camp Room", "Kiddie Camp"], ["10e", "10E Zal / Baking Kitchen", "Kitchen"], ["11e", "11E Smaller Kiddie Camp Room", "Kiddie Camp"], ["13", "13 Main Building", "Main"], ["13-basement", "13 Basement / TC Shul", "Shul"], ["8", "8 GYC Shul", "Shul"], ["15", "15 7th Grade Gazebo Shul", "Shul"], ["16", "16 4th Grade Gazebo Shul", "Shul"], ["2", "2 Home Depot", "Storage"], ["12", "12 Waitros Lounge / Basketball Court", "Staff"], ["11f", "11F Admin Office", "Office"], ["outdoor", "Outdoor Grounds / Trash Cans", "Outdoor"], ["bonfire", "Picnic Tables / Bonfire Area", "Outdoor"]
    ].map(function (item) { return { id: item[0], name: item[1], category: item[2] }; }),
    tasks: [
